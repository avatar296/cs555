...
echo ""
echo "  3. Create Bronze tables:"
echo "     docker-compose -f infra/docker-compose.yml up bronze-table-setup"
echo ""
echo "  4. Start your producers and Bronze consumers"
echo ""
echo "  5. Start Silver streaming consumers"
echo "     (Silver tables auto-created on first run - no setup needed!)"
echo ""
echo "NOTE: Silver tables are created automatically by streaming jobs."
echo "      No need to run silver-table-setup!"
echo ""
