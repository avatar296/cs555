...
public class ErrorInjector {
  ...
  private enum ErrorType {
    NULL_FARE(0.20),
    NULL_PASSENGERS(0.15),
    INVALID_PICKUP_ZONE(0.15),
    INVALID_DROPOFF_ZONE(0.15),
    NEGATIVE_DISTANCE(0.10),
    ZERO_DISTANCE(0.10),
    EXCESSIVE_DISTANCE(0.05),
    NEGATIVE_FARE(0.05),
    ZERO_PASSENGERS(0.03),
    EXCESSIVE_PASSENGERS(0.02);
