...
/**
 * Tests MessagingNode-specific functionality from PDF Section 1.2
 * Focus on node behavior, connection handling, and fault tolerance
 */
...
public class MessagingNodeComponentTest {
    ...
    void testRegistryDisconnection() throws Exception {
        ...
        Process nodeProcess = new ProcessBuilder(
            ...
            "localhost", String.valueOf(BASE_PORT + 1)
        ).start();
        Thread.sleep(2000);
    ...
    void testPeerConnectionRetry() throws Exception {
        ...
        try {
            ...
            // But since we use automatic port selection, it should succeed with different port
    ...
    void testPeerIdentificationProtocol() throws Exception {
        ...
        // Total sent should equal total received (no lost messages due to misidentification)
