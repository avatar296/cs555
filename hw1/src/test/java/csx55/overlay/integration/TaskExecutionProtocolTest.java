...
public class TaskExecutionProtocolTest {
    ...
    void testTaskInitiateDistribution() throws Exception {
        ...
        boolean foundTaskInitiate = output.stream()
            .anyMatch(line -> line.contains("TASK_INITIATE") || 
                            line.contains("TaskInitiate") ||
                            line.contains("Task initiated"));
        
        assertTrue(foundTaskInitiate || output.size() > 0, 
        ...
        boolean foundCompletion = output.stream()
            .anyMatch(line -> line.contains("rounds completed") || 
    ...
    void testMessageRoutingWithRounds() throws Exception {
        ...
        boolean found3Rounds = output.stream()
            .anyMatch(line -> line.contains("3 rounds completed"));
    ...
    void testTaskInitiationTriggersMessages() throws Exception {
        ...
        boolean foundCompletion = output.stream()
            .anyMatch(line -> line.contains("2 rounds completed"));
    ...
    void testRegistryWaitsForAllCompletions() throws Exception {
        ...
        long completionCount = output.stream()
            .filter(line -> line.contains("rounds completed"))
            .count();
