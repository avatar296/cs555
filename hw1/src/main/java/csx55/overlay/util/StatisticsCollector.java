...
/**
 * Collects and aggregates traffic statistics from all nodes in the overlay.
 * Thread-safe implementation for concurrent summary collection.
 * Displays formatted statistics once all nodes have reported.
 */
public class StatisticsCollector {
    ...
    /**
     * Adds a traffic summary from a node.
     * Thread-safe method for concurrent summary collection.
     * 
    ...
    /**
     * Prints aggregated statistics for all nodes.
     * Displays individual node statistics followed by totals.
     * Output format: nodeId sent received sumSent sumReceived relayed
     */
