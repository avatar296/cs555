...
/**
 * Handles command-line interface for MessagingNode. Provides an interactive command loop for user
 * interaction with the messaging node. Supports commands for displaying the minimum spanning tree
 * and exiting the overlay.
 */
public class MessagingNodeCommandHandler extends AbstractCommandHandler {
  ...
  /**
   * Processes commands specific to MessagingNode. Available commands: - print-mst: displays the
   * minimum spanning tree - exit-overlay: deregisters from the overlay and exits
   *
