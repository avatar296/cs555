 ...
 * Deserializes incoming network data into appropriate Event implementations
 * based on the protocol message type.
 * 
 * This factory maintains a single instance to ensure consistent
 * event creation throughout the application.
 */
public class EventFactory {
    ...
    /**
     * Creates an Event object from marshalled bytes.
     * Reads the message type from the byte array and instantiates
     * the appropriate Event implementation.
     * 
