...
/**
 * Notification message sent by a node to indicate task completion. After a node finishes sending
 * all required messages in a messaging task, it sends this message to the registry to report
 * completion.
 *
 * <p>Wire format: - int: message type (TASK_COMPLETE) - String: IP address of the node - int: port
 * number of the node
 */
