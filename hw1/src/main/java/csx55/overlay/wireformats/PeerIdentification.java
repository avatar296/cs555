...
/**
 * Message sent between peers to identify themselves after connection establishment. When two
 * messaging nodes establish a TCP connection, they exchange identification messages to properly map
 * connections to node identifiers.
 *
 * <p>Wire format: - int: message type (PEER_IDENTIFICATION) - String: node identifier (IP:port
 * format)
 */
