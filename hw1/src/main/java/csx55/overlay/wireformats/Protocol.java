...
/**
 * Defines protocol message type constants for the overlay network. Each constant represents a
 * unique message type that can be transmitted between nodes in the system.
 *
 * <p>Message types are used by EventFactory to deserialize incoming byte streams into the
 * appropriate Event implementation.
 */
