...
/**
 * Command message sent by the registry to initiate messaging tasks. Instructs nodes to begin
 * sending data messages for the specified number of rounds to test the overlay network.
 *
 * <p>Wire format: - int: message type (TASK_INITIATE) - int: number of rounds to execute
 */
